    ...
    const companyData = [
        {
            ...
            cost: [{count: "2인", cost: "30,000원"}, {count: "3인", cost: "40,000원"}],
                            ...
                            <FormGrid>
                                ...
                                <ModernParagraph>
                                    ...
                                    <FieldColumn>
                                        <ItemDiv
                                            name={'people'}
                                            width={'100%'}
                                            rules={[{required: true, message: '인원을 선택해주세요.'}]}
                                        >
                                ...
                                <ModernParagraph>
                                    ...
                                    <FieldColumn>
                                        <ItemDiv
                                            name={'difficulty'}
                                            rules={[{type: 'number', min: 0.5, message: '난이도를 선택해주세요.'}]}
                                        >
                                ...
                                <ModernParagraph>
                                    ...
                                    <FieldColumn>
                                        <ItemDiv name={'horror'}>
                                            <RateDiv character={<GiWaterDrop />} color={'red'} allowHalf disabled={isDisabled} />
                                        </ItemDiv>
                                    </FieldColumn>
                                </ModernParagraph>
                                ...
                                <ModernParagraph>
                                    ...
                                    <FieldColumn>
                                        <ItemDiv name={'activity'}>
                                            <RateDiv character={<GiFootprint />} color={'sienna'} allowHalf disabled={isDisabled} />
                                        </ItemDiv>
                                    </FieldColumn>
                                </ModernParagraph>
                    ...
                    <Sidebar>
                        <GuideCard>
                            ...
                            <GuideText lineHeight={'1.7'}>
                                입력 완성도를 높이면 검색 노출과 예약 전환에 도움이 됩니다.
                            </GuideText>
                            <GuideList>
