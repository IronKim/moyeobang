...
const Signup = () => {
    ...
    return (
        <MainContainer>
            <ProgressToast open={signupMutation.isLoading} text={'회원가입 처리 중입니다...'} />
            <MainBox height={'100%'}>
                {
                    page === 0 && <AccountEssential onInput={onInput} inputAccountData={inputAccountData} nextPage={nextPage} />
                }
                {
                    page === 1 && <AccountDetail Signup={handleSignup} inputAccountData={inputAccountData} onInput={onInput} isSigningUp={signupMutation.isLoading} />
                }
             </MainBox>
        </MainContainer>
    );
