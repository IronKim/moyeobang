...
@Tag(name = "PricePolicyUpdateRequest", description = "가격 정책 수정 요청 DTO")
@Getter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class PricePolicyUpdateRequest {

    @Schema(description = "정책명", example = "주말 심야")
    ...
    @Schema(description = "요일 비트마스크", example = "96")
    private Integer dayOfWeek;

    @Schema(description = "시작시간", example = "20:00:00")
    private LocalTime startTime;

    @Schema(description = "종료시간", example = "23:59:59")
